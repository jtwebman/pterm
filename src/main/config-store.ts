...
import type { Config, Project, ProjectBranch, ProjectCreateInput, ProjectUpdateInput, SettingsUpdateInput } from "../shared/types.js";
...
export class ConfigStore {
  ...
  updateSettings(input: SettingsUpdateInput): Config["settings"] {
    ...
    if (input.browserCommand !== undefined) this.config.settings.browserCommand = input.browserCommand;
