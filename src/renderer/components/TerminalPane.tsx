...
import type { Activity, TerminalSession } from "../../shared/types.js";
...
export function TerminalPane({ terminal, isVisible }: Props) {
	...
	useEffect(() => {
		...
		const webLinksAddon = new WebLinksAddon((_event, url) => {
			...
			void bridge.shell.openExternal(url, cmd);
		});
		...
		const onDataDisposable = xterm.onData((data) => {
			void bridge.terminal.write({ terminalId: terminal.terminalId, data });
		});
